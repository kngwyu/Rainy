...
@pytest.mark.parametrize('input_dim, batch_size, params, channels, hidden, init', [
    ((4, 84, 84), 32, None, None, (64, 7, 7),
     Initializer(weight_init=kaiming_normal(), nonlinearity='relu')),
    ((4, 84, 84), 64, None, None, (64, 7, 7), None),
    ((17, 48, 24), 64, [(8, 1), (4, 1), (3, 1)], None, (64, 36, 12),
     Initializer(weight_init=kaiming_uniform(), nonlinearity='leaky_relu')),
    ((17, 32, 16), 64, [(8, 1), (4, 1), (3, 1)], None, (64, 20, 4), None),
    ((3, 210, 160), 32, [(8, 2, (1, 1)), (6, 2, (1, 1)), (6, 2, (1, 1)), (4, 2)],
     (64, 128, 128, 128), (128, 11, 8), None),
])
def test_dqnconv(
